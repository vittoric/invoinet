...
import backgroundImage from '../assets/background-lines.svg'; // Asegúrate de que la ruta a la imagen es correcta

const TrustSection = () => {
  return (
    <div className="relative bg-white py-80 px-4 md:px-8 lg:px-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row items-start">
        <div className="w-full md:w-1/2 mb-8 md:mb-0 p-16 ">
          <h2 className="text-2xl md:text-3xl lg:text-4xl text-black corbel-bold  leading-tight mt-20">
